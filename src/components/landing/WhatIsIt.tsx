    ...
    <Section
      ...
      title={
        <>
          خریدار سازمان و
          <br />
          <span className="text-gradient-green">یادگیرنده فرده.</span>
        </>
      }
      subtitle="نورز یک دوره مشترک تیمی نیست. سازمان تعداد محدودی از افراد کلیدی خود را معرفی می‌کنه و هر فرد میبینه چطوری برای نقش شغلی خودش، یک سیستم شخصی کار با AI بسازه"
    >
